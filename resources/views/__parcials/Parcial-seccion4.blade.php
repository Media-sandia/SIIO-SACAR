<form action="#" class="form_section form-inline" id="form_section4"> 
    <fieldset class="container">
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="VLL">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
    ...
    <fieldset class="container">
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="Gancho principal">
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="Gancho Auxiliar">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
    ...
    <fieldset class="container">
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="Carro principal">
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="Carro auxiliar">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
    ...
    <fieldset class="container">
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="CL1">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="CL2">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
        ...
        <div class=" col-12 form-group" style="margin-bottom: 10px">
            ...
            <input type="text" class="form-control form-control-sm col-2 mr-3" name="C2.1"  placeholder="CL3">
            <input type="text" class="form-control form-control-sm col-4" name="C2.1"  placeholder="Comentario">
        </div>
          <input type="button" name="previous" class="previous btn btn-primary txt_secction " value="Anterior" />
