        ...
        <div class="col-lg-5 col-md-7">
          <div class="card  shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-3">
              ...
              @endif
              <form role="form" method="POST" action="{{route('login')}}" accept-charset="UTF-8" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group mb-3 {{$errors->has('email') ? 'has-error' : ''}}">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control border" placeholder="Correo" autofocus type="email" id="username" name="email" value="{{old('email')}}">
                  </div>
                ...
                <div class="form-group" {{$errors->has('password') ? 'has-error' : ''}}>
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control border" placeholder="Contraseña" type="password"  name="password" id="password">
                  </div>
